...
(function() {
  ...
  var scenes = data.scenes.map(function(data) {
	...
	container.createHotspot(document.getElementById('iframespot'), { yaw: 1.7335, pitch: -0.339 },
	{ perspective: { radius: 1080, extraTransforms: "rotateX(5deg)" }});
	container.createHotspot(document.getElementById('iframeselect'), { yaw: 0.9, pitch: -0.5 });
